// menu data 
const menuItems = [
    { id: 1, name: 'adrak chai', price: 30, isVeg: true },
    { id: 2, name: 'rose chai', price: 30, isVeg: true },
    { id: 3, name: 'masala chai', price: 30, isVeg: true },
    { id: 4, name: 'ilaichi chai', price: 30, isVeg: true },
    { id: 5, name: 'paneer wrap', price: 120, isVeg: true },
    { id: 6, name: 'Aloo Wrap', price: 100, isVeg: true },
    { id: 7, name: 'Veg Wrap', price: 100, isVeg: true },
    { id: 8, name: 'Paneer Sandwich', price: 160, isVeg: true },
    { id: 9, name: 'veg sandwich', price: 90, isVeg: true },
    { id: 10, name: 'Aalo Sandwich', price: 90, isVeg: true },
    { id: 11, name: 'Lassi', price: 90, isVeg: true },
