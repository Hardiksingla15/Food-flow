// menu data 
const menuItems = [
    { id: 1, name: 'Noodles', price: 130, isVeg: true },
    { id: 2, name: 'Spring roll', price: 90, isVeg: true },
    { id: 3, name: 'Manchuriyan', price: 140, isVeg: true },
    ...
    { id: 11, name: 'chinese Thali', price: 299, isVeg: true },
    { id: 12, name: 'Aloo Sandwich', price: 90, isVeg: true }
];
