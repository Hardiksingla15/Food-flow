// menu data 
const menuItems = [
    { id: 1, name: 'Plain Dosa', price: 100, isVeg: true },
    { id: 2, name: 'Paneer Dosa', price: 160, isVeg: true },
    { id: 3, name: 'Masala Dosa', price: 120, isVeg: true },
    { id: 4, name: 'Idli', price: 60, isVeg: true },
    { id: 5, name: 'Vada', price: 60, isVeg: true },
    { id: 6, name: 'Pav Bhaji', price: 100, isVeg: true },
    { id: 7, name: 'Uttapam', price: 120, isVeg: true },
    { id: 8, name: 'pyaz Dosa', price: 120, isVeg: true },
    { id: 9, name: 'pizza Dosa', price: 150, isVeg: true },
    { id: 10, name: 'Choclate Dosa', price: 190, isVeg: true },
    { id: 11, name: 'extra Pav', price: 40, isVeg: true },
    { id: 12, name: 'Cold Drink', price: 60, isVeg: true }
];
